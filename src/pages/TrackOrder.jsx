...
const getImageUrl = (value) => {
  ...
  if (url.startsWith("localhost:5000")) {
    return `https://${url}`;
  }
...
const getAssignedDriver = (order) => {
  ...
  const id = normalizeId(driver.id || driver._id);

  // Important:
  // On utilise la photo sauvegardée dans assignedDriver,
  // donc la photo du VRAI livreur ayant accepté cette commande.
  const photo =
    driver.photo ||
    driver.image ||
    driver.profileImage ||
...
export default function TrackOrder() {
  ...
  const orderId = useMemo(() => {
    const routeValue = normalizeId(routeId);
    ...
    const index = parts.indexOf("track-order");

    if (index >= 0 && parts[index + 1]) {
      const fallback = normalizeId(parts[index + 1]);
  ...
  useEffect(() => {
    ...
    const fetchOrder = async () => {
      ...
      try {
        ...
        console.log("ORDER :", normalizedOrder);
        console.log(
          "ASSIGNED DRIVER :",
          normalizedOrder.assignedDriver
        );
        console.log(
          "DRIVER GPS :",
          normalizedOrder.driverLocation
        );
        console.log("STATUS :", normalizedOrder.status);
        console.log("======================================");
        ...
        const gps = normalizedOrder.driverLocation;
        ...
        if (
          ...
          setLastGpsUpdate(gps?.updatedAt || null);
    ...
    const interval = orderId
      ? setInterval(fetchOrder, 3000)
      : null;
    ...
    <div className="track-order-page">
      ...
      <section className="status-card">
        <div className="status-top">
          ...
          <div>
            ...
            {!assignedDriver &&
              order.status !== "Livrée" && (
                <p className="waiting-driver-text">
      ...
      <main className="track-content">
            ...
            <div>
              ...
              <span>
                {assignedDriver
                  ...
                  : "En attente de l’acceptation d’un livreur"}
              </span>
            </div>
          ...
          <div className="map-container">
            {(driverPosition || customerPosition) ? (
                ...
                {customerPosition && (
                  ...
                  >
                    <Popup>
                      ...
                      <div className="customer-popup-address">
                        {order.address ||
                          order.district ||
                          order.city ||
                          "Adresse client"}
              ...
              <div className="no-gps">
                ...
                <span>
                  {assignedDriver
                    ? "La position apparaîtra dès que le livreur commencera à transmettre sa localisation."
                    : "La carte du livreur apparaîtra dès qu’un livreur aura accepté votre commande."}
                </span>
              </div>
            )}
          </div>
        ...
        {assignedDriver ? (
          ...
          <section className="no-driver-card">
            <div className="waiting-driver-icon">
              <FaClock />
            </div>
            ...
            <div>
              ...
              <p>
                Aucun livreur n’a encore accepté
                cette commande. Dès qu’un livreur
                acceptera la livraison, ses
                informations et sa photo
          ...
          order.status === "En livraison" && (
            <section className="qr-card">
              ...
              <div className="qr-security">
                <FaShieldAlt />
                Ce QR est unique à cette commande.
              </div>
            </section>
          )}
        ...
        <section className="info-footer">
          ...
          <div>
            ...
            <p>
              Cette page actualise
              automatiquement le statut et la
              position du livreur toutes les
              3 secondes.
            </p>
          </div>
        </section>
      ...
      <style>{`
        * {
        ...
        .waiting-animation span {
          ...
          border-radius:50%;
          background:#2563EB;
          animation:pulseDriver 1.2s infinite;
        }
